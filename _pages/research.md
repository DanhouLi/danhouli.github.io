  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    papers.forEach(function(paper) {
      ...
      if (titleElement && linkUrl) {
        ...
        titleElement.innerHTML = `<a href="${linkUrl}" target="_blank" style="color: inherit; text-decoration: underline; text-underline-offset: 4px; text-decoration-color: #0056b3;">${originalTitleText}</a>`;
