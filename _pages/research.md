...
main.container {
  ...
  nav .navbar-collapse, nav .navbar-nav {
    margin-right: -3.5px !important; /* Increase this to push buttons further left, or decrease to push right */
  }
  
  /* Dial back the navigation name nudge */
  nav .navbar-brand {
    margin-left: 7.6px !important; /* Try 0px first. If it needs a tiny push, try 2px or 3px */
