...
<script>
  document.addEventListener("DOMContentLoaded", function() {
    ...
    if (navbarContainer && !document.querySelector('.navbar-brand')) {
      ...
      // Give it the exact same classes and styling as the other pages
      myName.className = 'navbar-brand title font-weight-bold';
      myName.href = '/'; // Link back to the homepage
      myName.innerText = 'Danhou Li'; // Your name
      
      // Apply your custom font sizes and styles directly
      myName.style.fontSize = '1.5rem';
      myName.style.fontWeight = '700';
      myName.style.fontFamily = "'Roboto', sans-serif";
      myName.style.display = 'inline-block';
      
      // Inject it into the very front of the navigation bar
